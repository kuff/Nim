...
function contains_587202604(pattern_587202605, self_587202606) {
  var result_587202607 = false;

  var F = {procname: "jsre.contains", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 57;
    result_587202607 = self_587202606.test(pattern_587202605);
  framePtr = F.prev;

  return result_587202607;
...
if (!(contains_587202604("abc", jsregex_570425346))) {
F.line = 52;
...
if (!(!(contains_587202604("abcd", jsregex_570425346)))) {
F.line = 52;
...
if (!(contains_587202604("xabc", jsregex_570425346))) {
F.line = 52;
...
function startsWith_587202608(pattern_587202609, self_587202610) {
  var result_587202611 = false;

  var F = {procname: "jsre.startsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 60;
    result_587202611 = contains_587202604(pattern_587202609, new RegExp(toJSStr((makeNimstrLit("^") || []).concat(cstrToNimstr(self_587202610.source) || [])), self_587202610.flags));
  framePtr = F.prev;

  return result_587202611;
...
if (!(startsWith_587202608("abcd", jsregex_603979778))) {
F.line = 61;
...
function endsWith_587202621(pattern_587202622, self_587202623) {
  var result_587202624 = false;

  var F = {procname: "jsre.endsWith", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/js/jsre.nim", line: 0};
  framePtr = F;
    F.line = 67;
    result_587202624 = contains_587202604(pattern_587202622, new RegExp(toJSStr((cstrToNimstr(self_587202623.source) || []).concat(makeNimstrLit("$") || [])), self_587202623.flags));
  framePtr = F.prev;

  return result_587202624;
...
if (!(endsWith_587202621("abcd", jsregex_620756994))) {
F.line = 68;
...
function HEX3DHEX3D_637534220(x_637534222, y_637534223) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      var i_637534246 = 0;
      F.line = 75;
      var colontmp__637534328 = 0;
      F.line = 308;
      colontmp__637534328 = subInt((x_637534222).length, 1);
      F.line = 90;
      var res_637534330 = 0;
      Label2: do {
        F.line = 91;
          Label3: while (true) {
          if (!(res_637534330 <= colontmp__637534328)) break Label3;
            F.line = 308;
            i_637534246 = res_637534330;
            ...
            F.line = 93;
            res_637534330 = addInt(res_637534330, 1);
          }
      } while (false);
    } while (false);
    F.line = 312;
...
if (!(contains_587202604("nim javascript", jsregex_637534210))) {
F.line = 74;
...
if (!(contains_587202604("0123456789abcd", jsregex_637534210))) {
F.line = 74;
...
if (!(startsWith_587202608("abcd", jsregex_637534210))) {
F.line = 74;
...
if (!(endsWith_587202621("dabc", jsregex_637534210))) {
F.line = 74;
...
F.line = 74;
var digitsRegex_637534295 = new RegExp("\\d");
if (!(HEX3DHEX3D_637534220(("foo".match(digitsRegex_637534295) || []), []))) {
F.line = 74;
